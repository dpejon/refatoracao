	...
	<body>
		<div class="container">
			<div class="row main">
				...
				<h5><center>Tela para nossos avaliadores selecioarem posts</center></h5>
					<form class="" method="post" action="#">
						
					

						<div class="form-group">
							<label for="username" class="cols-sm-2 control-label"><center>Selecione o post</center></label>
							<div class="cols-sm-10">
								 <select type="text" class="form-control"  size="1" name="">
       										<option selected value="Selecione">---------  Selecione o post para avaliar  --------</option>
       										<option value="pode mexer">--</option>
       										<option value="pode mexer">--</option>
        									<option value="pode mexer">--</option>
								</select>
							</div>
						...
						<div class="form-group ">
							<a href="http://localhost:8080/ProjectWEB/AvaliadorEscolhe.html"  type="button" id="button" class="btn btn-primary btn-lg btn-block login-button">Avaliar</a>
						
						</div>
						<div class="form-group ">
							<a href="http://localhost:8080/ProjectWEB/mural.jsp"  type="button" id="button" class="btn btn-primary btn-lg btn-block login-button">Mural</a>
						
						</div>
						<div class="form-group ">
							<a href="" target="_blank" type="button" id="button" class="btn btn-primary btn-lg btn-block login-button">Sair</a>
